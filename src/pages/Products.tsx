        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="/products" className="text-green-600 hover:text-green-700 font-medium transition-colors border-b-2 border-green-600">Products</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-t animate-fade-in">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <a href="/products" className="block px-3 py-2 text-green-600 font-medium bg-green-50 rounded">Products</a>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-12">
            {products.map((product, index) => (
              <div key={product.id} className={`grid md:grid-cols-2 gap-8 items-start animate-fade-in ${index % 2 === 1 ? 'md:grid-flow-col-dense' : ''}`}>
                ...
                <div className={`${index % 2 === 1 ? 'md:col-start-1' : ''}`}>
                  ...
                  <h4 className="text-xl text-green-600 font-semibold mb-6">{product.type}</h4>
                  <div className="space-y-3">
                    {product.benefits.map((benefit, benefitIndex) => (
                      <div key={benefitIndex} className="flex items-start">
                        <span className="text-green-600 font-bold mr-3 mt-1 text-sm">{benefitIndex + 1}.</span>
                        <p className="text-gray-700 leading-relaxed text-sm">{benefit}</p>
                      </div>
                    ))}
                  </div>
                </div>
